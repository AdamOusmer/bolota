 ...
 *
 * Measured radial silhouette profiles (egg, hexagon, triangle). Not adapted — see ../engine.ts for the bolota-specific bridge
...
// theta = 0 points right and increases clockwise (y pointing down).
// Unit: resting ball radius = 1.
//
// Generated by tools/extract-profiles.py — do not hand-edit.

export const PROFILE_SAMPLES = 64

export const PROFILES = {
  // egg: same height as the ball, narrowed in width
  // image 164, measured footprint 1.647 x 2.000
  ...
  // image 174, measured footprint 1.826 x 2.011
  ...
  // image 190, measured footprint 1.995 x 1.884
