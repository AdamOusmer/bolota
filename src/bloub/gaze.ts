 ...
 * Not adapted — see ../engine.ts for the blobatar-specific bridge (seed-to-
 * silhouette conversion, DOM mounting, rAF loop, the `follow()` API). This
 * file's own logic, comments and variable names (French, in the original)
 * are untouched beyond TS-strict fixes and import paths.
 */
